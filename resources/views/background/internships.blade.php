    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                ...
                <p class="internship-subtitle">Prov 10:22</p>
                <h2 class="internship-title">Software Development</h2>

                <h5 class="mt-3 fw-bold text-primary">Web Development Intern</h5>
                ...
                <ul class="internship-list">
                    ...
                    <li>Built backend features with PHP & MySQL</li>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 text-light">
                ...
                <!-- DESCRIPTION -->
                <ul class="internship-list">
                    <li>Assisted in managing and updating website content using CMS tools.</li>
